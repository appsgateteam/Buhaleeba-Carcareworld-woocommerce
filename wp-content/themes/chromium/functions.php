...
if (file_exists(get_template_directory() . '/ysg/functions/common_functions.php')) {
	include_once get_template_directory() . '/ysg/functions/common_functions.php';
}
if (file_exists(get_template_directory() . '/ysg/functions/functions_rabie.php')) {
	include_once get_template_directory() . '/ysg/functions/functions_rabie.php';
}
