...
add_action('wp_enqueue_scripts', function () {
    wp_enqueue_script('ysg_common_jsscript', get_template_directory_uri() . '/ysg/scripts/common.js');
});
...
add_action('woocommerce_before_main_content', function () {
    if (is_shop() || is_product_category() || is_product_tag() || is_product_taxonomy()) {
        ...
        echo '<a href="javascript:void(0)" class="yg_show_hide_filter js_show_hide_filters"><i class="fa fa-bars"></i> <span>show filters</span></a>';
    }
}, 7);
