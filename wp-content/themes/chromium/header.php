...
<head>
    ...
    <?php endif; ?>
    <?php wp_head(); ?>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri() . '/ysg/css/main/main.min.css'; ?>">
</head>
...
<body <?php body_class(); ?>>
    ...
    <div id="page" class="site">
        ...
        <header class="site-header">
            ...
            <?php if (!chromium_elementor_header_enabled()) : ?>
                ...
                <?php if (has_nav_menu('primary-nav')) :
                    $nav_class = '';
                    if (true == get_theme_mod('primary_nav_widgets', true) && (is_active_sidebar('primary-nav-widgets'))) {
                        $nav_class = ' with-widgets';
                        if ('left' == get_theme_mod('primary_nav_widgets_position', 'right')) {
                            $nav_class .= ' reversed';
                        }
                    } ?>
                    <nav id="site-navigation" class="main-navigation primary-nav<?php echo esc_attr($nav_class); ?>" itemscope="itemscope" itemtype="http://schema.org/SiteNavigationElement" role="navigation">
                        <!-- Primary nav -->
                        <a class="screen-reader-text skip-link" href="#content"><?php esc_html_e('Skip to content', 'chromium'); ?></a>
                        <?php if (true == get_theme_mod('primary_nav_widgets', true) && (is_active_sidebar('primary-nav-widgets'))) {
                            echo '<div class="primary-nav-wrapper">';
                        } ?>
        ...
        if (function_exists('chromium_yoast_breadcrumbs') && function_exists('yoast_breadcrumb')) {
            chromium_yoast_breadcrumbs();
        }
        ?>