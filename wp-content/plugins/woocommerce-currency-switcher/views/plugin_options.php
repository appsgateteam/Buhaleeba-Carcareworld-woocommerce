...
<div class="subsubsub_section woocs_subsubsub_section">
    ...
    <?php if ($WOOCS->notes_for_free): ?>
        ...
        <div class="woocs-notice"><i>In the free version of the plugin <b class="woocs_settings_red">you can operate with 2 ANY currencies only</b>! If you want to use more currencies <a href="https://pluginus.net/affiliate/woocommerce-currency-switcher" target="_blank">you can make upgrade to the premium version</a> of the plugin</i></div><br />
        ...
        <table class="woocs_settings_promotion" >
            <tr>
                <td >
                    ...
                    <a href="https://pluginus.net/affiliate/woocommerce-currency-switcher" target="_blank"><img width="240" src="<?php echo WOOCS_LINK ?>img/woocs_banner.jpg" alt="<?php esc_html_e("full version of the plugin", 'woocommerce-currency-switcher'); ?>" /></a>
                </td>
