...
if (!defined('WOO_PR_VERSION')) {
    define('WOO_PR_VERSION', '2.1.4');      // Plugin Version
}
 ...
 * @since 1.1.0
 * */
function woo_pr_check_exclude_role( $userid = '', $is_signup = false ) {

    $role_valid = true;
    $userdata = array();
    if( is_user_logged_in() || $is_signup ){
...
function woo_pr_plugin_loaded() {
    ...
    if ( $exclude_role && class_exists('Woocommerce')) {
