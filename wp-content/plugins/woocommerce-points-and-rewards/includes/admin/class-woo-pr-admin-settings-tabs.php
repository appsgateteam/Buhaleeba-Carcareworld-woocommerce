        ...
        public function get_settings($current_section = '')
        {
            ...
            if ($current_section == 'woo_pr_product_purchase_setting') {
                ...
                $settings = apply_filters('woo_pr_redeeming_points_setting', array(
                    ...
                    /*array(
                        'name'      => esc_html__('Redeemed Points Deduction on Order Status :', 'woopoints'),
                        'desc'      => '<p class="description">' . esc_html__('Redeemed Points will be deducted when the Order Status reaches.', 'woopoints') . '</p>',
                        'id'        => 'woo_pr_redd_on_status',
                        'class'     => 'wc-enhanced-select',  
                        'default'  => array( 'wc-completed' , 'wc-processing' , 'wc-on-hold' ),                                           
                        'type'      => 'multiselect',
                        'options'   => $this->get_all_status()
                    ),*/
...
%1$s Your current balance is {total_point}%2$s', 'woopoints'), '<p>', '</p>'),
                ...
                $settings = apply_filters('woo_products_point_settings', array(
                    ...
                    array(
                        ...
                        'desc'      => '<p class="description">' . esc_html__('Select the user roles that you want to exclude from points and rewards system.', 'woopoints') . '</p>',
                    ...
                    array(
                        'title'     => esc_html__('Min Order Amount for 2x Point ', 'woopoints'),
                        'desc'      => esc_html__('Set the minimum order amount to award more points (2x)', 'woopoints'),
                        'id'        => 'woo_pr_ysg_ratio_multiplier',
                        'default'   => '300',
                        'type'      => 'number'
                    ),
...
?>
            <tr valign="top">
                ...
                <td class="forminp forminp-<?php echo esc_attr(sanitize_title($field['type'])); ?>">
                    ...
                    <textarea name="<?php echo esc_attr($field['id']); ?>" id="<?php echo esc_attr($field['id']); ?>" style="<?php echo esc_attr($field['css']); ?>" class="<?php echo esc_attr($field['class']); ?>" placeholder="<?php echo esc_attr($field['placeholder']); ?>" <?php echo implode(' ', $custom_attributes); // WPCS: XSS ok. 
                                                                                                                                                                                                                                                                                    ?>><?php echo esc_textarea($option_value); // WPCS: XSS ok. 
                                                                                                                                                                                                                                                                                                    ?></textarea>
            ...
            ?>
                <tr valign="top">
                    ...
                    <td class="forminp forminp-text">
                        ...
                        <?php }
                        if ($field['id'] == 'woo_pr_lables_points') { ?>
            ...
            <tr valign="top">
                ...
                <td class="forminp forminp-<?php echo esc_attr(sanitize_title($field['type'])); ?>">
                    <fieldset>
                        ...
                        ?>
                            <label><input name="<?php echo esc_attr($field['id']); ?>" value="<?php echo esc_attr($key); ?>" type="radio" style="<?php echo esc_attr($field['css']); ?>" class="<?php echo esc_attr($field['class']); ?>" <?php echo implode(' ', $custom_attributes); // WPCS: XSS ok. 
        ...
        public function woo_pr_render_days_callback($field)
        {
            ...
            ?>
                <tr valign="top">
                    ...
                    <td class="forminp forminp-text">
                        <fieldset>
                            <input step="<?php if (isset($field['step'])) {
                                                echo esc_attr($field['step']);
                                            } ?>" style="<?php if (isset($field['css'])) {
                                                                echo esc_attr($field['css']);
                                                            } ?>" min="<?php if (isset($field['min'])) {
                                                                                                                                                echo esc_attr($field['min']);
                                                                                                                                            } ?>" name="<?php echo esc_attr($field['id']); ?>" id="<?php echo esc_attr($field['id']); ?>" type="number" value="<?php echo esc_attr($file_val); ?>" /> <?php echo $filetype; ?>
                        </fieldset>
            ...
            ?>
                ...
                <tr valign="top" class="woopr-checkbox-group">
                    ...
                    <td>
                        ...
                        ?>
                        <span class="description"><?php echo esc_html__('Click on the actions for which you would like to send Points Earned email.', 'woopoints'); ?></span>
                    </td>
                </tr>
        ...
        public function render_woopr_checkbox($field)
        {
            ...
            ?>
                ...
                <div class="woopr-custom-checkbox">
                    <fieldset>
                        <input name="<?php echo esc_attr($field['id']); ?>" id="<?php echo esc_attr($field['id']); ?>" type="checkbox" value="yes" <?php checked($option_value, 'yes'); ?> <?php echo implode(' ', $custom_attributes); // WPCS: XSS ok. 
                                                                                                                                                                                            ?> />
