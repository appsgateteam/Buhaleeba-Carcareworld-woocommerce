...
<div class="wdr_purchase_previous_orders_group wdr-condition-type-options">
    ...
    <div class="wdr-previous-order-compare-method wdr-select-filed-hight">
        ...
        <span class="wdr_desc_text awdr-clear-both "><?php _e('Purchased quantity should be', WDR_PRO_TEXT_DOMAIN); ?></span>
    </div>
    ...
    <div class="wdr-previous-order-value wdr-input-filed-hight">
        <input name="conditions[<?php echo (isset($i)) ? $i : '{i}' ?>][options][count]"
               ...
               class="awdr-left-align float_only_field" placeholder="<?php _e('1', WDR_PRO_TEXT_DOMAIN);?>">
        <span class="wdr_desc_text awdr-clear-both "><?php _e('Purchased quantity', WDR_PRO_TEXT_DOMAIN); ?></span>
    </div>
