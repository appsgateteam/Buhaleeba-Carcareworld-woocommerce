...
echo ($render_saved_condition == true) ? '' : '<div class="purchase_previous_orders_for_specific_product">';
?>
<div class="wdr_purchase_previous_orders_for_specific_product_group wdr-condition-type-options">
    ...
    <div class="previous-order-against-product-method wdr-select-filed-hight">
        ...
        <span class="wdr_desc_text awdr-clear-both "><?php _e('Purchase Before', WDR_PRO_TEXT_DOMAIN); ?></span>
    </div>
    ...
    <div class="previous-order-against-product-comparision wdr-select-filed-hight">
        ...
        <span class="wdr_desc_text awdr-clear-both "><?php _e('Purchase Quantity Should Be', WDR_PRO_TEXT_DOMAIN); ?></span>
    </div>
    ...
    <div class="previous-order-against-product-amount wdr-input-filed-hight">
        <input name="conditions[<?php echo (isset($i)) ? $i : '{i}' ?>][options][count]"
               ...
               class="float_only_field awdr-left-align" placeholder="<?php _e('1', WDR_PRO_TEXT_DOMAIN);?>"
               min="1">
        <span class="wdr_desc_text awdr-clear-both "><?php _e('Purchase Quantity', WDR_PRO_TEXT_DOMAIN); ?></span>
    </div>
