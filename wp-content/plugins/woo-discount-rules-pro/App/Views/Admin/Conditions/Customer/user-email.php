...
<div class="wdr_user_email_group wdr-condition-type-options">
    ...
    <div class="wdr_value wdr-input-filed-hight">
        ...
        <span class="wdr_desc_text awdr-clear-both awdr_user_email_tld" ><?php _e('Example : edu, org', WDR_PRO_TEXT_DOMAIN); ?></span>
        <span class="wdr_desc_text awdr-clear-both awdr_user_email_domain"><?php _e('Example : gmail.com, yahoo.com', WDR_PRO_TEXT_DOMAIN); ?></span>
    </div>
</div>
