<?php
    ...
    elseif($file_used=="data_table"){
	    ...
	    $percentage_down_up_html='
            <span class="pw-val pw-sm-font">'.__('Up by',__PW_REPORT_WCREPORT_TEXTDOMAIN__).'</span>
            <span class="pw-green pw-lg-font">'.$percentage_down_up.'%</span>';
        ...
        if($net_amnt_last_x_days!=0){
            ...
            if($net_amnt>$net_amnt_last_x_days){
	            ...
	            $percentage_down_up_html='
	                <span class="pw-val pw-sm-font">'.__('down by',__PW_REPORT_WCREPORT_TEXTDOMAIN__).'</span>
                    <span class="pw-red pw-lg-font">'.$percentage_down_up.'%</span>';
            }else{
	            $percentage_down_up_html='
	                <span class="pw-val pw-sm-font">'.__('Up by',__PW_REPORT_WCREPORT_TEXTDOMAIN__).'</span>
                    <span class="pw-green pw-lg-font">'.$percentage_down_up.'%</span>';
...
//	            }
        ...
        <div class="col-xs-12 col-md-6">
            <div class="int-awr-box pw-main-box">
                <div class="awr-title">
                    <h3>
                        <i class="fa fa-money"></i>'.__('Sales',__PW_REPORT_WCREPORT_TEXTDOMAIN__).'</h3>
                ...
                <div class="int-awr-box-content">
                    <div class="pw-box-padder">                    
                        <div class="pw-pull-left pw-val pw-lg-font">'.$net_amnt.'</div>
        ...
        <div class="col-xs-12 col-md-6">
            <div class="int-awr-box pw-main-box">
                <div class="awr-title">
                    <h3>
                        <i class="fa fa-map-marker"></i>'.__('Sales heatmap',__PW_REPORT_WCREPORT_TEXTDOMAIN__).'</h3>
                    <div class="awr-title-icons">
                                               
                        <div class="awr-title-icon awr-add-fav-icon awr-tooltip-wrapper" data-smenu="all_orders">
                            <i class="fa  fa-info "></i>
                            <div class="awr-tooltip-cnt">
                                <div class="awr-tooltip-header">'.__('Sales heatmap',__PW_REPORT_WCREPORT_TEXTDOMAIN__).'</div>
                                <div class="awr-tooltip-content">'.__('Identify which is the most profitable day, time when your store makes a sale. Darker the spots, more the sales.',__PW_REPORT_WCREPORT_TEXTDOMAIN__).'</div>
                            </div>
                        </div>
                        <div class="awr-title-icon awr-setting-icon" style="display: none;"><i class="fa fa-cog"></i></div>
                        <div class="awr-title-icon awr-close-icon" style="display: none;"><i class="fa fa-times"></i></div>
                    ...
                    <div class="pw-box-padder">                    
                        ...
                        <div class="pw-pull-left pw-center-align pw-col2">
                            <div class="pw-val pw-sm-font">
                                '.__('One Sale Every',__PW_REPORT_WCREPORT_TEXTDOMAIN__).'
                            </div>
            ...
            <div class="int-awr-box pw-center-align pw-pr-sum-box">
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="pw-box-padder">
                        ...
                        <div class="pw-val pwl-lbl">'.__('NET SALES',__PW_REPORT_WCREPORT_TEXTDOMAIN__).'</div>
                    </div>    
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="pw-box-padder">
                        ...
                        <div class="pw-val pwl-lbl">'.__('AVERAGE REVENUE / SALE',__PW_REPORT_WCREPORT_TEXTDOMAIN__).'</div>
                    </div>    
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="pw-box-padder">
                        ...
                        <div class="pw-val pwl-lbl">'.__('AVERAGE REVENUE / DAY',__PW_REPORT_WCREPORT_TEXTDOMAIN__).'</div>
                    </div>    
                </div>
            </div>
        </div>';
        ...
        <div class="col-xs-12 col-md-4">
            <div class="int-awr-box pw-pr-customer-list">
                <div class="pw-box-padder">
                    <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper no-footer">
                        <table class="display datatable intelligence_customer_datatable dataTable no-footer" cellspacing="0" width="100%" id="DataTables_Table_1" role="grid" aria-describedby="DataTables_Table_1_info" style="width: 100%;">
                            <thead>
                                <tr role="row">
                                    <th style="width: 80px;" data-class="" class="sorting_disabled" rowspan="1" colspan="1"></th>
                                    <th style="width: 281px;" data-class="" class="sorting_disabled" rowspan="1" colspan="1"><div>'.__('Date',__PW_REPORT_WCREPORT_TEXTDOMAIN__).'</div></th>
                                    <th style="width: 224px;" data-class="" class="sorting_disabled" rowspan="1" colspan="1"><div>'.__('Customer',__PW_REPORT_WCREPORT_TEXTDOMAIN__).'</div></th>
                                    <th style="width: 142px;" data-class="" class="sorting_disabled" rowspan="1" colspan="1"><div>'.__('Amount',__PW_REPORT_WCREPORT_TEXTDOMAIN__).'</div></th></tr>
                            </thead>
        ...
        <div class="col-xs-12 col-md-8" id="pw_intelligence_customer_details">
