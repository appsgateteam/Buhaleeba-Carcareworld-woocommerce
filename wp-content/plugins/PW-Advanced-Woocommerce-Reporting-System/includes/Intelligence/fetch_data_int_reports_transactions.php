...
elseif($file_used=="data_table"){
	...
	$net_amnt=$part_refund_amnt=$order_count=$total_tax=0;
	$first_order_id='';
...
//	            }
	...
	$total_tax=($total_tax) == 0 ? $this->price(0) : $this->price($total_tax);
	...
	$output.= '
        ...
        <div class="col-xs-12 col-md-12">
            <div class="int-awr-box pw-center-align pw-pr-sum-box">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="pw-box-padder">
                        <div class="pw-lg-font pw-green">'.$total_tax.'</div>
                        <div class="pw-val pwl-lbl">'.__('TAX',__PW_REPORT_WCREPORT_TEXTDOMAIN__).'</div>
                    </div>    
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="pw-box-padder">
                        ...
                        <div class="pw-val pwl-lbl">'.__('TOTAL AMOUNT',__PW_REPORT_WCREPORT_TEXTDOMAIN__).'</div>
                    </div>    
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="pw-box-padder">
                        ...
                        <div class="pw-val pwl-lbl">'.__('TRANSACTIONS',__PW_REPORT_WCREPORT_TEXTDOMAIN__).'</div>
                    </div>    
                </div>
            </div>
        </div>';
