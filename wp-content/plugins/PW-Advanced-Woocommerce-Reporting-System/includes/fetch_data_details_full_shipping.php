...
//echo $sql;
    ...
    if ($pw_detail_view == "yes") {
        ...
        $columns = array(
            ...
            array('lable' => __('T-Shirt Size', __PW_REPORT_WCREPORT_TEXTDOMAIN__), 'status' => 'show'),
            array('lable' => __('Billing Address 1', __PW_REPORT_WCREPORT_TEXTDOMAIN__), 'status' => 'show'),
            array('lable' => __('Billing Address 2', __PW_REPORT_WCREPORT_TEXTDOMAIN__), 'status' => 'show'),
            array('lable' => __('Billing Post Code', __PW_REPORT_WCREPORT_TEXTDOMAIN__), 'status' => 'show'),
            ...
            array('lable' => __('Billing County', __PW_REPORT_WCREPORT_TEXTDOMAIN__), 'status' => 'show'),

            array('lable' => __('Shipping Address 1', __PW_REPORT_WCREPORT_TEXTDOMAIN__), 'status' => 'show'),
            array('lable' => __('Shipping Address 2', __PW_REPORT_WCREPORT_TEXTDOMAIN__), 'status' => 'show'),
            array('lable' => __('Shipping Post Code', __PW_REPORT_WCREPORT_TEXTDOMAIN__), 'status' => 'show'),
            array('lable' => __('Shipping City', __PW_REPORT_WCREPORT_TEXTDOMAIN__), 'status' => 'show'),
            array('lable' => __('Shipping State', __PW_REPORT_WCREPORT_TEXTDOMAIN__), 'status' => 'show'),
            array('lable' => __('Shipping County', __PW_REPORT_WCREPORT_TEXTDOMAIN__), 'status' => 'show'),
            ...
            //SHIPPING AMNT
            array('lable' => __('Delivery charge', __PW_REPORT_WCREPORT_TEXTDOMAIN__), 'status' => 'currency'),
            array('lable' => __('Order total', __PW_REPORT_WCREPORT_TEXTDOMAIN__), 'status' => 'currency'),
        );
    ...
    foreach ($this->results as $items) {
        ...
        if ($pw_detail_view == "yes") {
            if (1){
                ...
                $size = get_post_meta($order_id,'_billing_wcccf_id_k0FI4VfDRc48wqy',true);

                $datatable_value .= ("<td style='" . $display_class . "'>");
                $datatable_value .= $size;
                $datatable_value .= ("</td>");
