...
?>
	...
	public function widget($args, $instance)
	{
		...
		<?php if (!$inline) {
			echo '<div class="tz-login-form-wrapper">';
		} ?>
		...
		<form id="tz-login" class="ajax-auth" method="post">
			...
			<p class="username">
				<label for="username"><?php esc_html_e('Username or Email Address', 'tz-feature-pack'); ?><span class="required">*</span></label>
				<input type="text" class="tz-login-username" placeholder="<?php esc_html_e('Username or Email Address', 'tz-feature-pack'); ?>" name="username" required aria-required="true" 
				title="<?php esc_html_e('Digits and Letters only.', 'tz-feature-pack'); ?>">
			</p>
			<p class="password">
			...
			<p class="submit-wrapper">
				<a class="text-link" href="<?php echo wp_lostpassword_url(); ?>"><?php esc_html_e('Forgot password?', 'tz-feature-pack'); ?></a>
