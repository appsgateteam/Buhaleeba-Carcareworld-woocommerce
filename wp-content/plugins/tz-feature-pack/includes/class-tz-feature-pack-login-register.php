...
function tz_ajax_login()
{
  ...
  //edited by YSG -- ccheck nonce but dont stop 
...
function tz_ajax_register()
{
  ...
  //edited by YSG --
  check_ajax_referer('ajax-register-nonce', 'security', false);
  ...
  if (is_wp_error($user_check)) {
    ...
    ysgSendNewUserEmail($become_a_vendor, $user_register);
 ...
 * send new user email
 */
function ysgSendNewUserEmail($become_a_vendor, $user_id)
{
