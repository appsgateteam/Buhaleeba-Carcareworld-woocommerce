...
?>
        ...
        <?php else : ?>
            <div class="inline error">
                <p><strong><?php _e('Gateway Disabled', 'payfort_fort'); ?></strong>: <?php _e('Payfort FORT does not support your store currency at this time.', 'payfort_fort'); ?></p>
            </div>
        <?php
        endif;
    }
    ...
    private function _handleResponse($response_mode = 'online', $integration_type = PAYFORT_FORT_INTEGRATION_TYPE_REDIRECTION)
    {
        ...
        ysgLogInFile(json_encode($response_params));
        ysgLogInFile($response_mode);
