...
class WC_Twilio_SMS_Loader {
	...
	/** @var \WC_Twilio_SMS_Loader single instance of this class */
	...
	public function __clone() {
		...
		_doing_it_wrong( __FUNCTION__, sprintf( 'You cannot clone instances of %s.', get_class( $this ) ), '1.12.1' );
	}
	...
	public function __wakeup() {
		...
		_doing_it_wrong( __FUNCTION__, sprintf( 'You cannot unserialize instances of %s.', get_class( $this ) ), '1.12.1' );
	}
	...
	public function init_plugin() {
		...
		require_once( plugin_dir_path( __FILE__ ) . 'class-wc-twilio-sms.php' );
	...
	/**
	 * Displays any admin notices added with SV_WC_Twilio_SMS_Loader::add_admin_notice()
	 *
	 * @since 1.12.0
	 */
	...
	/**
	 * Gets the main SV_WC_Twilio_SMS_Loader instance.
	 *
	 * Ensures only one instance can be loaded.
	 *
	 * @since 1.12.0
	 *
	 * @return \WC_Twilio_SMS_Loader
	 */
