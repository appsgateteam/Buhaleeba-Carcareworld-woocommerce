    ...
    const fbCbPlugin = {
        ...
        init: function () {
            ...
            if (!window.getCookie('wacv_fb_checkbox')) {
                let html = `<div class='fb-messenger-checkbox' origin='${Fbook.homeURL}' page_id='${Fbook.pageID}' messenger_app_id='${Fbook.appID}' user_ref='${this.user_ref}' allow_login='true' size='large' ref='wacv_ref_message' skin='${Fbook.appSkin}'></div>`;
